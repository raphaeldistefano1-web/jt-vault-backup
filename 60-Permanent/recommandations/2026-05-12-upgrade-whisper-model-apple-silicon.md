...
Qualité de transcription meilleure → meilleur input pour Sonnet en analyse → digest plus précis sur les vidéos sans subs natifs (langues moins courantes sur YouTube : thaï, viet, certains accents). Coût : 1.6 GB de download initial + ~30 sec/vidéo de plus en moyenne.
