...
- quota
- tokens
id: 20260509040128-claude-max-5x-fenêtre-courte-à-réserver
intent: gotcha
...
status: active
summary: Claude Max 5x mange une fenêtre 5h en 2-3 usages complexes. À réserver aux
  3-4 décisions majeures annuelles, pas comme discipline quotidienne.
tags:
- permanent
- synthesized
- cost-awareness
- planning
tier: hot
title: 'Claude Max 5x : fenêtre courte, à réserver'
topic_cluster: subscription-usage
type: permanent-note
updated: '2026-05-09'
---

Piège : croire que Claude Max 5x offre une liberté illimitée.

Réalité : fenêtre glissante 5h, rechargement quotidien. Une session 2-3h complète (curation plugins, audit multi-agent, feature complexe) consomme 50-70% du quota en une journée.

**Décisions majeures à réserver pour Max** (3-4 par an max) :
- Refonte UI v3 (design+implementation+review)
- Migration booking engine WP
- Archi Veille IA v2
