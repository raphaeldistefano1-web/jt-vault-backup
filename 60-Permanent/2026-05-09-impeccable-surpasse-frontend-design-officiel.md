...
- pbakaus
- frontend-design
id: 20260509040127-impeccable-surpasse-frontend-design-officiel
intent: decision
...
status: active
summary: Impeccable (27 anti-patterns AI explicites) remplace frontend-design officiel
  comme référence qualité UI.
tags:
- permanent
- synthesized
- UI-anti-patterns
...
- design-tools
tier: warm
title: Impeccable surpasse frontend-design officiel
topic_cluster: design-tooling
type: permanent-note
updated: '2026-05-09'
---

Impeccable (pbakaus) banit 27 patterns de AI-generated UI slop explicitement : font sans-serif par défaut, couleurs oversaturées, spacing régulier mécanique, input borders thick, buttons shadow/glow excessif, animations sans raison, dégradés inutiles, etc.
