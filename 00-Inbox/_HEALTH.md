---
id: 20260623-vault-health
type: report
title: "🚨 Vault Health Check"
project: claude-system
status: active
summary: "Health check vault — généré 2026-06-23T04:00:02+0000"
intent: monitor
tier: hot
...
# 🏥 Vault Health — 2026-06-23 04:00:02 UTC
...
| Vault.db | ✅ | integrity ok, 27.7 MB |
| Curator log | ✅ | dernier run 2026-06-23 03:00 (il y a 1.0h) |
| Synthesizer log | ✅ | dernier run 2026-06-22 04:00 (il y a 24.0h) |
| Inbox backlog | ✅ | 0 notes en backlog |
| Notes non consolidées | ✅ | 28/1099 notes non consolidated |
| Index sync (FS vs DB) | ❌ | disk=1512, db=1452, drift=+60 (>5 → reindex incomplet) |
| Syncthing folder | ❌ | URLError: timed out |
| Disk free / | ✅ | 65.0 GB libre / 96 GB (32% used) |
