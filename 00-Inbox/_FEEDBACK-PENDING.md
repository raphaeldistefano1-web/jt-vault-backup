...
# 📋 Feedback rules en attente — 2026-06-21 09:00 UTC
...
_Auto-régénéré chaque dimanche 9h Paris par `/usr/local/bin/vault-feedback-pending` (cron `/etc/cron.d/vault-feedback-pending`)._
