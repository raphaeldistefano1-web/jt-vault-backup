...
created: 2026-05-12
description: Stub — infrastructure email Le Jardin Tropical (Brevo, Orange, DKIM/SPF/DMARC,
  migration domaine pro)
embed_hash: null
...
project: null
status: stub
summary: Stack email — Brevo transac PMS/WP, lejardintropical@orange.fr boîte pro
  (à migrer)
tags:
- email
- infra
...
- **Transactionnel PMS/WP** : [[_MOC-n8n]] et Brevo (cf. mémoire CC `reference_n8n.md`)
